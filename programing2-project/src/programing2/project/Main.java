    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("chose an option :\n [0] end the program\n [1] add new doctor\n [2] delete existing doctor\n"
                    ...
                    + " [12] show numbre of patient in specific department ");
            ...
            switch (op) {
                ...
                case 4:
                    ...
                    if (InternFound) {
                        ...
                        System.err.println("threr is no intern");
                    }
                    break;
                case 5:
                    int doctorCountre = 0;
                    ...
                    switch (op4) {
                        case 1:
                            System.err.println("numbre of all doctor is: " + Hospital.doctorList.size());
                            System.out.println("");
                            break;
                        case 2:
                            for (Doctor e : Hospital.doctorList) {
                            ...
                            System.err.println("numbre of intern doctor is: " + doctorCountre);
                            System.out.println("");
                            break;
                        case 3:
                            for (Doctor e : Hospital.doctorList) {
                            ...
                            System.err.println("numbre of specialized doctor is: " + doctorCountre);
                            System.out.println("");
                            break;
                        case 4:
                            for (Doctor e : Hospital.doctorList) {
                                ...
                                switch (op7) {
                                    case 1:
                                        ...
                                        for (int i = 0; i < attendNumbre; i++) {
                                            System.err.println("chose attend doctor by id");
                ...
                case 11:
                    ...
                    break; 
                case 12 :
                    System.out.println("chose an option\n [1] show numbre patient of all time\n [2] show numbre of patient in specific time zone");
                    int op8 = in.nextInt();
                    int patientCount =0 ;
                    switch (op8) {
                        ...
                        case 1:
                            for (Patient p : Hospital.patientList) {
                             ...
                             System.out.println("numbre of patient is :" + patientCount);
                            break;
